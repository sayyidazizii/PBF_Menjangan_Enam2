                    ...
                    <table class="table table-bordered table-advance table-hover">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th style='text-align:center'> Discount A</th>
                                <th style='text-align:center'>Total After Discount A</th>
                                <th style='text-align:center'>Discount B(%)</th>
                                <th style='text-align:center'> Discount B</th>
                                <th style='text-align:center'>Total After Discount B</th>
                                <th style='text-align:center'>PPN</th>
                                <th style='text-align:center'>Total After PPN</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            @else
                                ...
                                @foreach ($salesorderitem AS $key => $val) 
                                    ...
                                    $price_after_discount_amount = $total_price_after_discount_item   - $salesorder['discount_amount'];
                                @endphp
